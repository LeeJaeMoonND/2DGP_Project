...
class slime():
    def __init__(self):
        ...
        self.frame = 0
        self.direction = 0
        self.p1 = [random.randint(150, 1130), random.randint(100, 635)]
    ...
    def update(self):
        ...
        self.t += 0.005
        if self.t >= 1.0:
            self.p1, self.p2, self.p3, self.p4 = self.p2, self.p3, self.p4, [random.randint(150, 1130), random.randint(100, 635)]
            self.t = 0